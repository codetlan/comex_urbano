...
Video.create!([
  {name: "Arte Urbano", description: "Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde", link: "https://www.youtube.com/watch?v=WO5X9ZUzqXM", visit: nil, active: 1},
