...
Section.create!([
                    {title: "Arte Urbano", description: "Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas \"Letraset\", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.", active: 1, main_banner_file_name: "banner_principal.png", main_banner_content_type: "image/png", main_banner_file_size: 650965, main_banner_updated_at: "2014-06-19 00:54:34", secondary_banner_file_name: "banner_secundario.png", secondary_banner_content_type: "image/png", secondary_banner_file_size: 563369, secondary_banner_updated_at: "2014-06-19 00:54:36", category_id: 1}
                ])
Video.create!([
                  {name: "Arte Urbano", description: "Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde", link: "https://www.youtube.com/watch?v=WO5X9ZUzqXM", visit: nil, active: 1, section_id: 1},
                  {name: "Arte Contemporaneo", description: "Es muy bello", link: "https://www.youtube.com/watch?v=tSWWA8NA5g8", visit: nil, active: 1, section_id: 1},
                  {name: "Arte Visual", description: "nombree", link: "https://www.youtube.com/watch?v=GRdF8u_wNhk", visit: nil, active: 1, section_id: 1}
              ])
About.create!([
